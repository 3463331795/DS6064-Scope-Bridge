...
<img src="ds6064_scope_bridge/docs/assets/cover.jpg" alt="RIGOL DS6064 三通道 PWM 采集现场" width="620">
...
- Python 3.10+。
- 已安装并可用的 NI-VISA。
- `ds6064_scope_bridge/requirements.txt` 中的 Python 依赖。
...
<img src="ds6064_scope_bridge/docs/assets/output-snapshot-framed.png" alt="DS6064 Scope Bridge 生成的三通道波形图" width="720">

一次典型采集会在实现目录的 `ds6064_scope_bridge/outputs/` 文件夹下生成类似这些文件：

```text
ds6064_scope_bridge/outputs/csv/20260711_170952_CH1_CH2_CH3_snapshot.csv
ds6064_scope_bridge/outputs/images/20260711_170952_CH1_CH2_CH3_snapshot.png
ds6064_scope_bridge/outputs/manifests/20260711_170952_CH1_CH2_CH3_snapshot.json
```
...
```text
SKILL.md
ds6064_scope_bridge/.agents/skills/rigol-ds6064-scope/SKILL.md
```
...
更详细的 CLI 合同见 [ds6064_scope_bridge/docs/CLI_CONTRACT.md](ds6064_scope_bridge/docs/CLI_CONTRACT.md)。
...
根目录只保留 `LICENSE`、`README.md`、`SKILL.md` 三个入口文件，其余实现、文档、测试、配置和示例产物都收在 `ds6064_scope_bridge/` 下。

所有示波器采集产物都应该放在实现目录下的 `outputs/` 文件夹中。CLI 会从自身文件位置推导这个目录，不依赖固定盘符路径。
